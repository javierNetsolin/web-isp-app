...
export default function HomePage(){
  ...
  const classIcons = 'fill-primary max-w-[90%] max-h-[90%] drop-shadow-[0_10px_10px_rgba(0,0,0,0.15)]'
    const list = [
        {
          title: "Planes",
          img: addBasket,
      ...
      return (
        ...
        <div className="gap-6 grid grid-cols-2 sm:grid-cols-4 max-w-1280 mx-auto px-8 py-4 text-center">
          {list.map((item, index) => (
            <Card shadow="sm" key={index} isPressable className="hover:bg-slate-200" onPress={() => navigateTo(item.link)}>

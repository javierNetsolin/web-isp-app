    ...
    <div className="flex flex-col gap-4">
      <div className="flex justify-between items-center">
        <span className="text-default-400 text-small">
          Cliente:{' '}
          <span className="text-default-800 text-small">Consorcio Express</span>{' '}
        </span>
        <span className="text-default-400 text-small">
          Bus: <span className="text-default-800 text-small">D223</span>{' '}
        </span>
      </div>
    </div>
  );
  ...
  return (
    <>
      <div className="flex py-2 px-2 flex-col gap-4 justify-between">
        ...
        <span className="text-default-400 text-small">
          Subtotal: ${' '}
          <span className="text-default-800 text-small"> 1.271.158 </span>{' '}
        </span>
        <span className="text-default-400 text-small">
          Iva: $ <span className="text-default-800 text-small"> 241.520 </span>{' '}
        </span>
        <span className="text-default-400 text-small">
          Total: ${' '}
          <span className="text-default-800 text-small"> 1.512.678 </span>{' '}
        </span>
...
export default function QuoteTable() {
  return (
    <>
      ...
      <Textarea
        label={
          <span className="text-default-800 text-medium">Observaciones </span>
        }
